...
namespace Bat2Exe
{
    ...
    {
        public static readonly string github_link = "https://github.com/dehoisted", my_telegram = "https://t.me/Constex", updates_link = "https://raw.githubusercontent.com/dehoisted/Bat2Exe/main/Updates/update.txt";
        public static readonly string program_version = "1.1", last_updated = "7/15/2021";
        ...
        private void creditsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            var op = MessageBox.Show("Would you like to visit the project link?", "Question", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            switch(op)
            {
        ...
        private void checkForUpdatesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                case "0":
                    MessageBox.Show("No updates available.", "Update Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    break;

                case "1":
                    var q1 = MessageBox.Show("Updates Available!\nWould you like to go and view the latest release?", "Update Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
                    switch (q1)
                    {
                        case DialogResult.Yes:
