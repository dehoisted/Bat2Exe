...
namespace Bat2Exe
{
    ...
    {
        public const string github_link = "https://github.com/dehoisted", my_telegram = "https://t.me/Constex", updates_link = "https://pastebin.com/raw/DS0hgb0F", 
            program_version = "2.0", last_updated = "9/16/2021";
        private string obf_bat_path = "obfuscated_source.bat", batch_cmd, batch_filepath = "", icon_filepath = "", OutputP, SourceP, LogP, update_str;
        ...
        {
            MessageBox.Show("Obfuscates the contents within your batch file and puts it in the generated executable.", "Note", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void ObfuscateBatchCode()
        {
            ...
            switch (guna2ComboBox2.Text)
            {
                case "alphabet (1)":
                    ...
                    bObf = new BObfuscator("", BObfuscator.Methods.alphabet);
                    break;
                case "junk (2)":
                    listBox1.Items.Add("Obfuscating batch code using \"junk\" method...");
                    bObf = new BObfuscator("", BObfuscator.Methods.junk);
                    break;
                default:
            ...
            File.WriteAllText("Source\\" + obf_bat_path, batch_cmd);
        }
        // Compile Event
        [Obsolete]
