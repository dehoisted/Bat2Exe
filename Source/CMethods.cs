...
namespace Bat2Exe 
{
    class Program
    {
        ...
        private static string bat_2_exe_credits = ""https://github.com/dehoisted/Bat2Exe"";
...
namespace Bat2Exe
{
    ...
    {
        ";
            string code_text2 = "private static string batch_cmd = @\"" + batch_cmd + "\";string bat_2_exe_credits = \"https://github.com/dehoisted/Bat2Exe\";";
            string code_text3 = @"
        public static void Main()
        {
